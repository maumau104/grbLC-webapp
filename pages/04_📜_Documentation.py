...
![Logo](grblLC-webapp/pages/logo.jpeg)  
...
st.markdown("""
    We present the largest optical photometry compilation of Gamma-Ray Bursts (GRBs) with measured redshifts ($z$). 
    Our dataset includes 64813 observations of 535 events (including upper limits) from 28 February 1997 to 18 August 2023. 
    We introduce grbLC, a user-friendly web tool for visualising photometry, coordinates, redshift, host-galaxy extinction, 
    and spectral indices for each event in our database. Additionally, we have integrated a Gamma-ray Coordinate Network (GCN) scraper 
    ...
    and a centralised repository for optical photometry, our web-based archive represents a significant step towards 
    unifying various community efforts to collect GRB photometric data. This comprehensive catalogue facilitates 
